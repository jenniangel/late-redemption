...
/**
 * If this is a listen server, this is set to True when the listen host is authenticated with steam
...
/** Caches the list of UID's passed into ReadOnlineStats, and puts them through one at a time instead of all at once (Steamworks crash workaround) */
