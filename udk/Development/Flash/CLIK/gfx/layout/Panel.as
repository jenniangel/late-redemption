...
[InspectableList("vconstrain", "hconstrain", "focusModeVertical", "focusModeHorizontal", "bUsePercentHeight", "bUsePercentWidth", "wPercentage", "hPercentage", "controllerMask", "visible", "enableInitCallback")]
...
// Public Properties:
	...
	/** true if the repositioning of the panel should take into account the new stage size vs. the old stage size, false if it should maintain the original pixel offset. */
	[Inspectable(defaultValue="false")]
	public var bUsePercentHeight:Boolean = false;
	[Inspectable(defaultValue="false")]
	public var bUsePercentWidth:Boolean = false;
	[Inspectable(type="Number", defaultValue="0")]
	public var wPercentage:Number = 0;
	[Inspectable(type="Number", defaultValue="0")]
	public var hPercentage:Number = 0;
