...
// Private Methods		
	...
	/** Helper function to set focusEnabled / tabEnabled for all components. */
	public function SetFocusEnabled( bEnableFocus:Boolean )
	{
		this.focusEnabled = bEnableFocus;
		this.tabEnabled = bEnableFocus;
		...
		for (var i:Number = 0; i < ArrayLength; i++)
		{
			...
			if (renderer != null) 
			{
				renderer.focusEnabled = bEnableFocus;
				renderer.tabEnabled = bEnableFocus;
			}
		}
	}
}