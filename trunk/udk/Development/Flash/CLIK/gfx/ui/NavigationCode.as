...
// Constants
	...
	/** A constant representing the navigation direction "up" from the right joystick */
	public static var GAMEPAD_RS_UP:String = "rs_up";
	/** A constant representing the navigation direction "down" from the right joystick */
	public static var GAMEPAD_RS_DOWN:String = "rs_down";
	/** A constant representing the navigation direction "left" from the right joystick */
	public static var GAMEPAD_RS_LEFT:String = "rs_left";
	/** A constant representing the navigation direction "right" from the right joystick */
	public static var GAMEPAD_RS_RIGHT:String = "rs_right";
